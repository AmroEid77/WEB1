...
const CardVideo = (props) => {
  ...
  return (
    <div className="col-lg-2 col-md-3 col-sm-4 col-6 mb-4" style={{ maxWidth: '20%' }}>
      <div className="card" style={{ borderRadius: '15px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
        <div className="ratio ratio-16x9" style={{ borderRadius: '15px 15px 0 0', overflow: 'hidden' }}>
          <ReactPlayer
            url={props.dataVideo}
            light={true}
            playing={false}
        ...
        <div className="card-body d-flex flex-column fs-xs fs-lg-5" style={{ fontSize: 'medium' }}>
          <a
          ...
          <div className="mt-auto">
            <div className="publisher d-flex align-items-center">
              <div className="card-text fs-smaller mb-0 pb-0">
                ...
                <p className="text-muted  text-muted mb-0">&nbsp; {props.views} views</p>
              </div>
            </div>
          </div>
        </div>
